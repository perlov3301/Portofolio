...
<body style="background-color:#ebebe0;">
  ...
  <fieldset style="border-radius:0.5em;">
    <legend style="background-color: darkolivegreen;color: white;padding: 3px 10px 3px 10px;"
            >2014-2016</legend>
  ...
  <fieldset style="border-radius:0.5em;">
    <legend style="background-color: darkolivegreen;color: white;">2017-2019</legend>
